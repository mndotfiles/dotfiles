...
- `touch .envrc`
- Determine Python version required by repo and update the first line. `pyenv install VERSION` if missing
...
# any issues with requirements, remove the specific version of packages to see if it will install
```
